...
class DerandomizedSmoother(nn.Module): 
    ...
    def forward(self, x, nclasses, threshold=None, return_mode=None): 
...
def certify(args, model, attacker, validation_loader, store=None): 
    ...
    for i,(X,y) in enumerate(pbar): 
        ...
        # attacker model
        # attacked = attacker.perturb(X,y,float('inf'),random_count=1).detach()
